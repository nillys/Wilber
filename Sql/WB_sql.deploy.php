...
<div id="main_container">
    ...
    try {
        $req = DB::$pdo->query('CREATE TABLE IF NOT EXISTS `comment` (
        ...
        // $req = DB::$pdo->query("INSERT INTO `comment` (`id`, `title`, `author`, `body`, `category`, `date_post`) VALUES (NULL, 'Wilber', 'Nillys', 'Le logiciel avance bien je suis fier d\'annoncer qu\'il a atteint la version 0.1.0 (alpha) . La route sera longue jusqu\'à ce qu\'il soit doté de toutes les fonctionnalités que j\'espère qu\'il aura mais ... La route est amusante .', 'Les développeur', '2020-08-27 23:37:54'");
        //MESSAGE SUCCES
        $check_count += 1;
    ...
    try {
        $req = DB::$pdo->query('CREATE TABLE IF NOT EXISTS `article` (
        `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
        `title` varchar(255) NOT NULL,
        `author` varchar(100) NOT NULL,
        `body` text NOT NULL,
    ...
    try {
        $req = DB::$pdo->query('CREATE TABLE IF NOT EXISTS `contact` (
        `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
        `title` varchar(255) NOT NULL,
        `author` varchar(100) NOT NULL,
        `body` varchar(255) NOT NULL,
