...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="CSS/WB_user_account.css">
...
<body>
    ...
    <div class="container-fluid background_container">
        <div class="row justify-content-center">
            <div class="col-lg-3"> <?php if(isset($_SESSION)){
                var_dump($_SESSION['logged_in']);
            }else{
                echo "<h1>Aucun utilisateur n'est connecté</h1>";
            } ?></div>
